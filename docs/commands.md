...
| `/adopt [agent]` | Opens a full-screen confirmation preview and waits for `y` to apply the diff as uncommitted changes (`n` cancels). Name an agent to override the reviewed winner. |
