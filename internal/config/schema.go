...
func Schema() []SchemaSection {
	return []SchemaSection{
		...
		{
			Title: "ui.themes.<name>",
			Intro: "A custom palette. Each role is an optional 256-color index (`\"212\"`) or hex (`\"#ff5f87\"`); unset roles inherit the `default` palette. Indexed-256 only (no truecolor).",
			Fields: []SchemaField{
